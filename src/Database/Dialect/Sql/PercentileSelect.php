...
final class PercentileSelect
{
    ...
    {
        // A percentile the match does not list falls through to `default`, which answers the
        // same '0.95' the 0.95 arm returns. The overlap is deliberate: an unrecognized
        // percentile must answer p95 rather than throw, because this string is spliced into
        // SQL and a null there is a syntax error at runtime on a dashboard nobody was looking at.
