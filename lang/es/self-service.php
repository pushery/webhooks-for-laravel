...
return [
    ...
    'empty' => [
        ...
        'no_deliveries' => [
            ...
            'description' => 'Todavía no se ha enviado nada a tus endpoints. Las entregas más antiguas que el periodo de retención se eliminan, así que una anterior pudo estar aquí y ya no estar.',
    ...
    'toast' => [
        ...
        'ping_sent' => 'Evento de prueba enviado.',
        'ping_disabled' => 'Este endpoint está desactivado, así que un evento de prueba no llegaría.',
        'ping_throttled' => 'Este endpoint ha agotado sus eventos de prueba por ahora. Inténtalo de nuevo en :seconds segundo(s).',
    ],
    ...
    'validation' => [
        ...
        'event_types' => [
            'string' => 'Un tipo de evento debe ser un nombre, no un número ni una lista.',
            ...
            'in' => 'Este tipo de evento no lo publica esta aplicación.',
        ],
    ],
    ...
    'a11y' => [
        ...
        'deliveries_table' => 'Entregas recientes',
    ],
];
