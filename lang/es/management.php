...
return [
    'form' => [
        'error_summary' => '{1} El formulario tiene un error.|[2,*] El formulario tiene :count errores.',
        'name_label' => 'Nombre',
    ...
    'subscription' => [
        ...
        'auto_disabled' => 'Desactivado automáticamente tras :count fallos consecutivos',
        'enable' => 'Activar',
        'disable' => 'Desactivar',
        'edit' => 'Editar',
        'rotate' => 'Rotar clave',
    ...
    'messages' => [
        ...
        // Se muestra cuando un ping de prueba se rechaza por haber agotado su cupo del minuto.
        'ping_throttled' => 'Este endpoint ya ha agotado sus pings de prueba por ahora. Vuelve a intentarlo en :seconds segundo(s).',
    ],
    ...
    'validation' => [
        ...
        'url' => [
            ...
            // is translated.
            'url' => 'Introduce una URL de endpoint válida. Debe empezar por http:// o https://.',
