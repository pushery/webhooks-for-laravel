...
return [
    ...
    'drawer' => [
        ...
        'payload_offloaded' => 'Dieser Rumpf war zu groß für das Log und wurde auf die Disk :disk ausgelagert. Was hier steht, ist der Stummel aus dem Log — nicht der zugestellte Rumpf.',
