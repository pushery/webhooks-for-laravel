...
return [
    ...
    'drawer' => [
        ...
        'payload_offloaded' => 'Deze body was te groot voor het log en is verplaatst naar de schijf :disk. Wat je hier ziet is het stukje dat het log heeft bewaard, niet de bezorgde body.',
